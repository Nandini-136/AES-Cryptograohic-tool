...
# Encryption class to handle file encryption
class Encryption:
...
# Decryption class to handle file decryption
class Decryption:
...
cprint('{} {}'.format(space_count + 3 * ' ', 'AES .'), 'green')
while True:
 ...
 |___|_||_\__|_|  \_, | .__/\__|_\___/_||_|
        ...
        cprint('Enter the filename for Encryption with proper extension:', end=' ', color='yellow',
               attrs=['bold'])
        file = input()
        E1 = Encryption(file)
        E1.encryption()
